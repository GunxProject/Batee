...
buttons = [
    [
        InlineKeyboardButton(
            text="➕️ Tambahkan Ke Grup ➕️",url="t.me/Bateerobot?startgroup=true"),
    ],
    [
        InlineKeyboardButton(
...
def gabi_about_callback(update, context):
    ...
    if query.data == "gabi_":
        query.message.edit_text(
            text=""" ℹ️ Goar hu *Batee*, sebuah bot untuk membantu mengatur grup anda.
                 \n❍ Au Boi restrict users.
                 \n❍ Au Boi greet users with customizable welcome messages and even set a group's rules.
                 \n❍ Au Boi an advanced anti-flood system.
                 \n❍ Au Boi warn users until they reach max warns, with each predefined actions such as ban, mute, kick, etc.
                 \n❍ Au have a note keeping system, blacklists, and even predetermined replies on certain keywords.
